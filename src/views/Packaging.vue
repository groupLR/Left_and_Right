<template>
 ...
 <div class=" mx-auto text-center">
  <h2 class=" font-extrabold text-[28px]">BR包裝紙盒，你還可以這樣利用...</h2>
 </div>
 <div class="relative w-full h-[400px]">
  <iframe 
    title="vimeo-player" 
    src="https://player.vimeo.com/video/407526808?h=10130a63b7&autoplay=1&muted=1&loop=1" 
    class="w-full h-full"
    frameborder="0" 
...
<!-- 1118 新品 / NEW ARRIVAL router link -->
