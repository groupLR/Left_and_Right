...
<template>
	...
	<div class="container mx-auto px-4 py-8">
		<div
			class="product-list grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6"
		>
			<div
			...
			>
				<a href="#">
					...
					>
						<img
							class="frontImg w-full object-cover"
					...
					<div class="px-2.5 pt-2.5 pb-7 mb-6 text-center lg:relative lg:mb-0">
						...
						<p
							class="mb-1 text-base text-gray-500 line-through"
