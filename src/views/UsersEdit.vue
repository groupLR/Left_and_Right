...
import { useUsersInformation, selected, validateInformation, onlyNum } from "/src/stores/memberInformation.js"
...
const validateAll = () => {
  ...
  // 檢查是否有錯誤訊息
  return Object.keys(memberValidationErrors).length === 0 && Object.keys(deliverValidationErrors).length === 0
}
// 驗證使用者資料欄位
...
<template>
  ...
  <div class="p-10 pt-0 mb-10 mx-auto w-full justify-center flex-auto container">
    <div class="w-[90%] flex-auto my-0 mx-auto justify-center bg-white p-10 flex-wrap border-x border-b lg:w-full">
      <div class="grid w-full grid-cols-1 gap-5 justify-between lg:grid-cols-2">
        <form id="profile">
          <div class="w-full p-[25px_21px] pb-5 border">
            ...
            <div class="name">
              <label>姓名</label>
              <input type="text" v-model="information.username" @blur="validateMemberField('username')" :class="{ 'is-invalid': memberErrors.username }" />
            ...
            <div class="email">
              ...
              <input type="email" v-model="information.email" @blur="validateMemberField('email')" :class="{ 'is-invalid': memberErrors.email }" />
            ...
            <div class="gender">
              ...
              <select v-model="information.gender" @change="onChange">
                <option value="m" :selected="information.gender === 'm'">男</option>
                <option value="f" :selected="information.gender === 'f'">女</option>
                <option value="o" :selected="information.gender === 'o'">不透露</option>
              </select>
            </div>
            <div class="birthday">
              <label for="">生日日期</label>
              <input type="date" v-model="information.birthday" @blur="validateMemberField('birthday')" :class="{ 'is-invalid': memberErrors.birthday }" />
            ...
            <div class="address">
              ...
              <div class="addressRightArea">
                <ul>
                  <li>
                    <p>收件人</p>
                    <input type="text" v-model="deliverInfo.recipient" :placeholder="deliverInfo.recipient === null ? '未填寫' : ''" />
                  </li>
                  <li>
                    <p>收件人電話號碼</p>
                    <div>
                      ...
                      <input
                        ...
                        @input="validateNumber"
                        maxlength="10"
                        :placeholder="deliverInfo.recipient_phone === null ? '未填寫' : ''"
                  ...
                  <li>
                    <p>送貨地點</p>
                    <select v-model="deliverInfo.country" @change="onChange" :placeholder="deliverInfo.country === null ? '請選擇' : ''">
                  ...
                  <li>
                    <p>地區</p>
                    <input type="text" v-model="deliverInfo.region" :placeholder="deliverInfo.region === null ? '未填寫' : ''" />
                  </li>
                </ul>
              </div>
            </div>
