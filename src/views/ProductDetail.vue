      ...
      <div class="profile">
        ...
        <div class="m-4 mt-5">
          ...
          <div class="flex">
            ...
            <h2 class="mt-6 ml-5 font-bold text-gray-400 line-through text-s">NT${{ originalPrice }}</h2>
          </div>
          ...
          <div class="colorChoose">
            ...
            <div class="flex">
              <div v-for="(color, index) in filterColor" :key="color.title">
                <input type="radio" name="colorChoose" class="hidden colorCheckbox" :id="`color-${index}`" :checked="index === 0" />
                <div
                ...
                >
                  <label
                    :for="`color-${index}`"
                    class="flex justify-center w-10 h-10 m-auto cursor-pointer"
          ...
          <div class="my-5">
            ...
            <div class="max-w-full w-full flex h-[40px] my-2.5">
              ...
              <input type="number" min="1" value="1" class="w-full text-center border border-gray-300 border-x-0" v-model="counter" />
              <button class="rounded-lg border border-gray-300 bg-gray-50 w-[45px] h-[40px] text-[20px]" @click="increase">+</button>
            </div>
          </div>
          <div class="grid grid-cols-2 gap-5 my-5">
            <button class="p-1 text-lg bg-black border border-black rounded-lg text-gray-50" @click="handleAddToCart">加入購物車</button>
            <button class="p-1 text-lg bg-black border border-black rounded-lg text-gray-50" @click="showDialog">
              <i class="ml-4 text-xl fa-brands fa-shopify"></i>
              加入共享購物車
            </button>
          </div>
          <div class="flex justify-center mx-auto my-5 text-sm hover:cursor-pointer">
            <p :class="{ active: isSubscribe }" @click="toggleHeart" :style="heartColor"><i class="mr-1 fa-regular fa-heart"></i>加入追蹤清單</p>
          </div>
          <div class="relative mx-5 mt-5 promotionalContainer">
          ...
          <button class="text-gray-500 border-none">收起內容<i class="fa-solid fa-angle-up"></i></button>
        </div> -->
        </div>
      </div>
      <!-- 商品描述 -->
      <div class="descriptionProfile">
        <div class="p-5">
          ...
          <div>
            ...
            <div class="relative flex justify-center mx-10 my-auto descriptionTitle">
              <h3 class="mt-5 text-2xl tracking-widest">了解更多</h3>
            </div>
